...
- They are pre-installed in Codespaces' workspace: Docker, Docker Compose, NVM, and Node.js.

# Information about Node.js and NVM

- for list versions of node: nvm ls

- for choice once: `nvm install + version` (ex: lts/hydrogen);

- Each version has a  chemical element  nickname, apparetly.

- lts: It provides support for a longer time.
